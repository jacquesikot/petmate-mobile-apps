...
const useLoadAssets = (assets: number[], fonts: FontSource): boolean => {
  ...
  usePromiseAll(
    [Font.loadAsync(fonts), ...assets.map((asset: number) => Asset.loadAsync(asset))],
    () => setReady(true),
  );
  return ready;
};
...
const NavigationContainer = ({
  ...
  const [stickyNavInitialState, setStickyNavInitialState] = useState<InitialState | undefined>();
